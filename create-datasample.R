...
## All users dataset and order by Time
...
### ---- Check if the merge was correct
...
ResultMerge[, names(ResultMerge)[c(2:9, 11, 13:14)]:= lapply(.SD, function(x) as.numeric(as.factor(x)) ), 
.SDcols = c(2:9, 11, 13:14)]
